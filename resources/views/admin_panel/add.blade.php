                        ...
                        <div class="row">
                            ...
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="name" placeholder="Ashley Jackson" class="form-control ">
                                    @if ($errors->has('name'))
                            ...
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <input type="email" name="email" placeholder="Ashley@gmail.com" class="form-control ">
                                    @if ($errors->has('email'))
                                        <span class="invalid-feedback" role="alert">
                            ...
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="nic" placeholder="XXXXXXXXXXV" class="form-control ">
                                    @if ($errors->has('nic'))
                                        <span class="invalid-feedback" role="alert">
                            ...
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="address" placeholder="60,Galpotha Road,Dehiwala" class="form-control ">
                            ...
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <input type="tel" name="tpno" placeholder="07XXXXXXXX" class="form-control ">
                                    @if ($errors->has('tpno'))
                                        <span class="invalid-feedback" role="alert">
