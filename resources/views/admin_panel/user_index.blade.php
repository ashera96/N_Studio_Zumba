            ...
            <div class="row">
                ...
                <div class="col-lg-2 col-md-3">
                    <div class="list-group shadow-sm">
                        ...
                        <a href="/admin/customers" class="list-group-item active side-bar"><i class="fa fa-users fa-lg mr-1"></i> Customers</a>
                        <a href="users.html" class="list-group-item side-bar"><i class="fa fa-bell fa-lg mr-1"></i> Notifications</a>
                        <a href="/admin.html" class="list-group-item side-bar"><i class="fa fa-dollar fa-lg mr-1"></i> Payments</a>
