...
<div class="col-lg-2 col-md-3 sideFix ">
    <div class="list-group shadow-sm">
        ...
        <a href="/admin/notifications" class="list-group-item side-bar"><i class="fa fa-bell fa-lg mr-1"></i> Notifications</a>
        ...
        <a href="/admin/classes" class="list-group-item side-bar"><i class="fa fa-clipboard fa-lg mr-1"></i> Classes</a>
