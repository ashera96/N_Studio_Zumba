...
<div class="col-lg-2 col-md-3 sideFix ">
    <div class="list-group shadow-sm">
        ...
        <a href="/recep/cusprofile" class="list-group-item side-bar {{Request::is('recep/cusprofile') ? "active" : ""}}"><i class="fa fa-users fa-lg mr-1"></i> Customers</a>
        <a href="/recep/schedules" class="list-group-item side-bar {{Request::is('recep/schedules') ? "active" : ""}}"><i class="fa fa-calendar fa-lg mr-1"></i> Schedules</a>
