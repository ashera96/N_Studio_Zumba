                    ...
                    <div class="card-body">
                        ...
                        <form method="POST" action="{{ route('register') }}"  aria-label="{{ __('Register') }}">
                            ...
                            <div class="form-group row">
                                <label for="name" class="col-md-4 col-form-label text-md-right text-white">{{ __('Full Name') }}</label>
                            ...
                            <div class="form-group row">
                                <label for="nic" class="col-md-4 col-form-label text-md-right text-white">{{ __('NIC') }}</label>
                            ...
                            <div class="form-group row">
                                <label for="dob" class="col-md-4 col-form-label text-md-right text-white">{{ __('Date Of Birth') }}</label>
                            ...
                            <div class="form-group row">
                                <label for="address" class="col-md-4 col-form-label text-md-right text-white">{{ __('Address') }}</label>
                            ...
                            <div class="form-group row">
                                <label for="contactno" class="col-md-4 col-form-label text-md-right text-white">{{ __('Contact Number') }}</label>
                            ...
                            <div class="form-group row">
                                <label for="medicissue" class="col-md-4 col-form-label text-md-right text-white">{{ __('Medical Issues(If any)') }}</label>
                            ...
                            <div class="form-group row mb-0">
                                <div class="col-md-6 offset-md-4">
                                    <a href="/index" class="btn btn-primary active" style="width: 48%;" role="button" aria-pressed="true">Back</a>
